...
public class ContactoServlet extends HttpServlet {
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            Contacto contacto = obtenerContacto(request); // enviar como parametro
            Contacto contacto_result = ContactoDAL.obtenerPorId(contacto);//se llena con lo que se llena el objeto anterior.
    ...
    private void doPostRequestEdit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {
                request.setAttribute("accion", "index");
                doGetRequestIndex(request, response);//llenar la tabla con 10 registros
            } else {
